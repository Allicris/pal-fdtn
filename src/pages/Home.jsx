...
import agenda from "../../public/agendas/agenda06042026.pdf"; // CHANGE TO THE NEW AGENDA YOU UPLOADED
  ...
  return (
    <>
      ...
      <p className="meeting-info">
        Our next teleconference Board Meeting is scheduled for Thursday, September 17, 2026 at 10:00 am. Kristine will send a ZOOM-link for you to call in.</p> 
